...
import com.revature.security.boot.db.exception.DataSourceOperationFailedException;
import com.revature.security.boot.db.exception.DuplicateRecordException;
...
public class DataRetrieverHibernateImpl implements DataRetriever, Serializable {
  ...
  public <E> List<E> retrieveByHQL(String queryString, List<QueryParameter<?>> queryParameters)
    ...
    try {
      ...
      logger.debug(String.format(
          "Retrieved the result based on the query : %s , with the parameters : %s, and the size of data : %d",
  ...
  public <E> List<E> retrieveByHQL(String queryString, List<QueryParameter<?>> queryParameters,
    ...
    try {
      logger.debug(String.format(
          "Retrieving the result based on the query : %s , with the parameters : %s ,properties : %s",
  ...
  public <E> List<E> retrieveBySQL(String queryString, List<QueryParameter<?>> queryParameters)
    ...
    try {
      ...
      logger.debug(String.format(
          "Retrieved the result based on the sql query : %s , with the parameters : %s, size of data : %d",
          queryString, getJsonString(queryParameters), GET_SIZE.apply(objects)));
    } catch (Exception exception) {
      String msg = DataAccessUtils.getInstance().getPropertyFileValue(RETRIEVAL_FAILS);
      logger.error(exception.getMessage(), exception);
  ...
  public <E> List<E> retrieveBySQL(String queryString, QueryProperties queryProperties)
    ...
    try {
      ...
      logger.debug(String.format(
          "Retrieved the result based on the sql query : %s , with the query properties : %s, size of data : %d",
          queryString, getJsonString(queryProperties), GET_SIZE.apply(objects)));
    } catch (Exception exception) {
      String msg = DataAccessUtils.getInstance().getPropertyFileValue(RETRIEVAL_FAILS);
      logger.error(exception.getMessage(), exception);
  ...
  public <E> List<E> retrieveBySQL(String queryString, List<QueryParameter<?>> queryParameters,
    ...
    try {
      logger.debug(String.format(
          "Retrieving the result based on the sql query : %s , with the parameters : %s ,properties : %s",
          queryString, getJsonString(queryParameters), getJsonString(queryProperties)));
      ...
      logger.debug(String.format(
          "Retrieved the result based on the sql query : %s , with the parameters : %s ,properties : %s, size of data : %d",
          queryString, getJsonString(queryParameters), getJsonString(queryProperties),
          GET_SIZE.apply(objects)));
    } catch (Exception exception) {
      String msg = DataAccessUtils.getInstance().getPropertyFileValue(RETRIEVAL_FAILS);
  ...
  public <E> List<E> retrieveByHQLWithLimits(String queryString, Integer startLimit,
    ...
    try {
      logger.debug(String.format(
          "Retrieving the result based on the query : %s , with start limit : %d ,no of records : %d",
          queryString, startLimit, endLimit));
      ...
      logger.debug(String.format(
          "Retrieved the result based on the query : %s , with start limit : %d ,no of records : %d, size of data : %d",
  ...
  public <T> List<T> retrieveByHQLResultTransformer(String queryString,
    ...
    try {
      ...
      if (queryString != null) {
        ...
        objects = query.list();
        logger.debug(String.format(
            "Retrieved the result based on the sql query : %s , parameters : %s, size of data : %d ",
            queryString, getJsonString(queryParameters), GET_SIZE.apply(objects)));
      }
    } catch (Exception exception) {
      String msg = DataAccessUtils.getInstance().getPropertyFileValue(RETRIEVAL_FAILS);
  ...
  public <E> List<E> retrieveBySQLResultTransformer(String queryString, Class<?> t, Integer start,
    ...
    try {
      logger.debug(String.format(
          "Retrieving the result based on the sql query : %s  , start limit : %d, no of records : %d",
          queryString, start, size));
  ...
  public <E> List<E> retrieveByHQLUniqueRoot(String queryString,
    ...
    try {
      ...
      if (queryString != null) {
        ...
        logger.debug(String.format(
            "Retrieved the result based on the query : %s , with parameters : %s, size of data : %d ",
            queryString, getJsonString(queryParameters), GET_SIZE.apply(objects)));
      }
    } catch (Exception exception) {
      String msg = DataAccessUtils.getInstance().getPropertyFileValue(RETRIEVAL_FAILS);
